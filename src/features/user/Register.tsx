...
function Register () {
  ...
  const submitForm = (e) => {
    ...
    if (registerObj.name.trim() === '') { setErrorMessage('Name is required! (use any value)'); return }
    if (registerObj.emailId.trim() === '') { setErrorMessage('Email Id is required! (use any value)'); return }
    if (registerObj.password.trim() === '') { setErrorMessage('Password is required! (use any value)') } else {
      setLoading(true)
