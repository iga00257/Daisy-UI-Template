...
function ForgotPassword () {
  ...
  const submitForm = (e: React.SyntheticEvent) => {
    ...
    if (userObj.emailId.trim() === '') { setErrorMessage('Email Id is required! (use any value)') } else {
      setLoading(true)
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => { submitForm(e) }}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <InputText type="emailId" defaultValue={userObj.emailId} updateType="emailId" containerStyle="mt-4" labelTitle="Email Id" updateFormValue={updateFormValue} labelStyle={''} placeholder={''}/>
                                ...
                                <div className='text-center mt-4'>Dont have an account yet? <Link to="/register"><button className="  inline-block  hover:text-primary hover:underline hover:cursor-pointer transition duration-200">Register</button></Link></div>
                            </form>
                        </>
                    }
